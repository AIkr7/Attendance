...
def face_recog():
	...
	workbook = xlsxwriter.Workbook('C:\\Users\\Afdal\\Attendance\\Reports\\Report_for_'+ datetime.datetime.now().strftime("%Y_%m_%d-%H")+'.xlsx')
	worksheet = workbook.add_worksheet()
	conn = sqlite3.connect('C:\\Users\\Afdal\\Attendance\\attendance\\site.db')
	c = conn.cursor()
